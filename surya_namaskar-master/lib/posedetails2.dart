...
class PoseList {
  ...
  void initializePoses() {
    poses = List<PoseDetails2>.empty(growable: true);
  ...
  PoseDetails2 _createPoseIntro() {
    PoseDetails2 newPose = new PoseDetails2();
